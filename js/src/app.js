...
define(['jquery', 'settings', 'apiService', 'utils'], function ($, config, apiService, utils) {
    $(function () {
            ...
            if (text !== "") {
                ...
                if (globalLpChat) {
                    ...
                    processor.askBot(checkEmoji(text) ? checkEmoji(text) : text, text, function (error, html) {
                        ...
                        //     } else if(html == "pay"){
                        //         callpaytm();
                        //     } else if(html == "datepick"){
                        //         html = `<li class="animated fadeInLeft list-group-item background-color-custom"><div class="pmd-card pmd-card-default pmd-z-depth custom-infocard">
                        //         <!-- Card header -->
                        //         <div class="pmd-card-title"><div class="datepicker-here" id = "custom-cells" data-timepicker="true" data-language="en"></div>
                        //          </div> <div class="pmd-card-media" id="pmd-card-media">
                                    
                        //             </div><div class="pmd-card-title">
                        //         <h3 class="card-body"><p class="card-title"></p>
                        //         </h3></div><div class="pmd-card-actions"> 
                        // <button type="button" id="cells-confirm" class="btn btn-primary infocard-btn-custom cardresponsepayload" data-cardpayloadbutton="Confirm">Confirm</button>
                        // </div></div></li>`;
                        //         msg_container.append(html);
                        //         utils.scrollSmoothToBottom($('div.chat-body'));
                        //          //var finddiv = msg_container.append(html);
                        //          setTimeout(() => {
                        //             $picker = document.getElementById('custom-cells');
                        ...
                        //             })
                        //         }, 2000)
                                //$("#custom-cells").css("display", "block");
                                //msg_container.append($('#custom-cells'));
                                //$("#pmd-card-media").append( $('#custom-cells').clone());
                                //$("#custom-cells").appendTo("#pmd-card-media");
                            } else {
            ...
            for (var i = 0; i < data.lines.length; i++) {
                ...
                if (line.source !== 'visitor' || chatState != chat.chatStates.CHATTING) {
                    ...
                    if (line.text == "end chat") {
                        ...
                        if (!textF.includes('Ally says :')) {
                            var html_div = '<li class="animated fadeInLeft list-group-item background-color-custom"><table border="0" cellpadding="0" cellspacing="0"><tr><td style="vertical-align:top;"><img width="35" height="35" src="avatar/logo-large.png"/></td><td><div class="media-body bot-txt-space"><p class="list-group-item-text-bot">' + textF + '</p><p class="bot-res-timestamp"><small> <img style="border-radius:50%;border:2px solid white;" width="20" height="20" src="https://bpvault.blob.core.windows.net/uploads/Cvj4pzU1Dc3M1496803460459.png"/>' + utils.currentTime() + '</small></p></div></td></tr></table></li>';
                            if (msg_container.hasClass('hidden')) { // can be optimimzed and removed from here
                                msg_container.siblings("h1").addClass('hidden');
                                msg_container.siblings("div.chat-text-para").addClass('hidden');
                                msg_container.siblings(".header-text-logo").removeClass('hidden');
        ...
        //         //var html_div = '<li class="animated fadeInRight list-group-item background-color-custom"><table border="0" cellpadding="0" cellspacing="0"><tr><td style="vertical-align:top;"><img width="35" height="35" src="avatar/logo-large.png"/></td><td><div class="media-body bot-txt-space"><p class="list-group-item-text-bot">'+line.text+'</p><p class="bot-res-timestamp"><small> <img style="border-radius:50%;border:2px solid white;" width="20" height="20" src="https://bpvault.blob.core.windows.net/uploads/Cvj4pzU1Dc3M1496803460459.png"/>'+utils.currentTime()+'</small></p></div></td></tr></table></li>';
        //         if (msg_container.hasClass('hidden')) { // can be optimimzed and removed from here
        //             msg_container.siblings("h1").addClass('hidden');
        //             msg_container.siblings("div.chat-text-para").addClass('hidden');
        //             msg_container.siblings(".header-text-logo").removeClass('hidden');
        ...
        function sendLine() {
            ...
            if (text && chat) {
                ...
                //var html_div = '<li class="animated fadeInLeft list-group-item background-color-custom"><table border="0" cellpadding="0" cellspacing="0"><tr><td style="vertical-align:top;"><img width="35" height="35" src="avatar/logo-large.png"/></td><td><div class="media-body bot-txt-space"><p class="list-group-item-text-bot">'+text+'</p><p class="bot-res-timestamp"><small> <img style="border-radius:50%;border:2px solid white;" width="20" height="20" src="https://bpvault.blob.core.windows.net/uploads/Cvj4pzU1Dc3M1496803460459.png"/>'+utils.currentTime()+'</small></p></div></td></tr></table></li>';
        ...
        function offline() {
            var html_div = '<li class="animated fadeInLeft list-group-item background-color-custom"><table border="0" cellpadding="0" cellspacing="0"><tr><td style="vertical-align:top;"><img width="35" height="35" src="avatar/logo-large.png"/></td><td><div class="media-body bot-txt-space"><p class="list-group-item-text-bot">Sorry our Ally agent service is offline. Please email us your queries queries@allianz.com </p><p class="bot-res-timestamp"><small> <img style="border-radius:50%;border:2px solid white;" width="20" height="20" src="https://bpvault.blob.core.windows.net/uploads/Cvj4pzU1Dc3M1496803460459.png"/>' + utils.currentTime() + '</small></p></div></td></tr></table></li>';
            if (msg_container.hasClass('hidden')) { // can be optimimzed and removed from here
                msg_container.siblings("h1").addClass('hidden');
                msg_container.siblings("div.chat-text-para").addClass('hidden');
                msg_container.siblings(".header-text-logo").removeClass('hidden');
