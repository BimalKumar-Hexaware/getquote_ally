            ...
            askBot(userInput, userText, callback) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.result.action == "AccidentIntimation-yes-yes") {
                            //console.log("AccidentIntimation-yes-yes");
                        ...
                        if (response.result.action == "Allianz") {
                            var html_div = `<li class="animated fadeInLeft list-group-item background-color-custom"><table border="0" cellpadding="0" cellspacing="0"><tr><td style="vertical-align:top;"><img width="35" height="35" src="avatar/logo-large.png"/></td><td><div class="media-body bot-txt-space"><p class="list-group-item-text-bot">I am connecting you to a representative. This may take a few moments. Please wait...</p><p class="bot-res-timestamp"><small> <img style="border-radius:50%;border:2px solid white;" width="20" height="20" src="https://bpvault.blob.core.windows.net/uploads/Cvj4pzU1Dc3M1496803460459.png"/>` + utils.currentTime() + `</small></p></div></td></tr></table></li>`;
                            ...
                            utils.scrollSmoothToBottom($('div.chat-body'));
                            callback(null, "Liveengage");
                        // } else if (response.result.action == "datepick") {
                        //     // utils.captureTranscript(dataList);
                        //     // fallbackCount,oFallbackCount = 0;
                        //     // callback(null, "Liveengage");
                        //     callback(null, 'datepick');
                        // } else if (response.result.action == "pay") {
                        //     // utils.captureTranscript(dataList);
                        //     // fallbackCount,oFallbackCount = 0;
                        //     // callback(null, "Liveengage");
                        //     callback(null, 'pay');
